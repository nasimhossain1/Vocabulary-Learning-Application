            ...
            <div className="relative z-10 flex items-center w-full">
              ...
              <div className="px-6 md:px-12 lg:px-16 max-w-3xl text-white">
                ...
                <p className="mt-5 text-base md:text-lg lg:text-xl text-white/90 leading-relaxed">
                  Learn Japanese vocabulary in a simple and
                  enjoyable way with structured lessons,
                  pronunciation practice and real-life examples.
                </p>
          ...
          >
            ...
            <div className="relative z-10 flex items-center w-full">
              ...
              <div className="px-6 md:px-12 lg:px-16 max-w-3xl text-white">
                ...
                <p className="mt-5 text-base md:text-lg lg:text-xl text-white/90 leading-relaxed">
                  Discover useful Japanese words and learn
                  how to use them naturally in everyday
                  conversations.
                </p>
          ...
          >
            ...
            <div className="relative z-10 flex items-center w-full">
              ...
              <div className="px-6 md:px-12 lg:px-16 max-w-3xl text-white">
                ...
                <p className="mt-5 text-base md:text-lg lg:text-xl text-white/90 leading-relaxed">
                  Listen to pronunciation, understand meanings
                  and practice Japanese vocabulary with practical
                  examples.
                </p>
      ...
      <section className="px-4 py-12 md:py-16">
        ...
        >
          ...
          <p className="text-base md:text-lg text-base-content/70 leading-relaxed">
            Lingo Bingo is a fun and interactive vocabulary
            learning application designed to help learners
            improve their Japanese vocabulary. Our goal is to
            make language learning easier by combining
            structured lessons, pronunciation practice,
            examples and interactive learning activities.
          </p>
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-base-content/60">
              Learn Japanese vocabulary with thousands of
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="mt-3 text-base-content/60 max-w-2xl mx-auto">
              Simple tools and useful features to make your
              Japanese vocabulary learning journey easier.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Listen to Japanese words and practice their
                  pronunciation to improve your speaking skills.
                </p>
            ...
            >
              ...
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Learn vocabulary through 10 carefully
            ...
            >
              ...
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Understand when and how to use each word
                  through practical Japanese examples.
                </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            >
              ...
              <p className="text-base-content/60">
                Select a lesson and explore vocabulary
            ...
            >
              ...
              <p className="text-base-content/60">
                Listen, practice and learn new words
                regularly to improve your Japanese.
              </p>
      ...
      <section className="px-4 py-12 md:py-20">
        ...
        >
          ...
          <p className="text-white/85 max-w-2xl mx-auto mb-8">
            Build your Japanese vocabulary step by step,
